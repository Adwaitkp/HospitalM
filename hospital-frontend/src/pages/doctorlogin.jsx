...
const DoctorLogin = () => {
  ...
  const handleDoctorLogin = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(`${API_URL}/doctor/login`, { email, password });
      ...
      localStorage.setItem("doctorToken", token); // ✅ Fixed key

      showNotification("Doctor login successful", "success");
      navigate("/doctor-dashboard"); // ✅ Navigate directly
    } catch (error) {
